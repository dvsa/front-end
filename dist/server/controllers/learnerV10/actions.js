...
function actionsGet(req, res) {
  ...
  if (action === 'addedToLearningPlan') {
    ...
    redirectPath = '/prototypes/learner/v10/home';
  }
  ...
  if (action === 'completeFireTraining' && id === '15') {
    ...
    redirectPath = '/prototypes/learner/v10/scorms/basic-fire-safety/complete';
  }
  ...
  if (action == 'workAreaHasBeenUpdated') {
    ...
    redirectPath = '/prototypes/learner/v10/your-profile';
  }
  ...
  if (action == 'showPreFilteredResults') {
    ...
    redirectPath = '/prototypes/learner/v10/search';
  }
...
function actionsPost(req, res) {
  ...
  /*if (action === 'addedToLearningPlan') {
          ...
          redirectPath = '/prototypes/learner/v10/suggested-learning';
      }*/
