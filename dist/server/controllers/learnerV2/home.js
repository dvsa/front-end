...
function homeGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/home/index', viewData);
}
...
function plannedGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/learning-plan/index', viewData);
}
...
function profileGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/profile/index', viewData);
}
...
function recordGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/learning-record/index', viewData);
}
...
function suggestedGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/suggested-learning/index', viewData);
}
...
function searchGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/search/index', viewData);
}
...
function searchPost(req, res) {
  ...
  return res.redirect('/prototypes/learner/v2/search');
}
...
function actionsGet(req, res) {
  ...
  if (action == 'addedToLearningPlan') {
    ...
    redirectPath = '/prototypes/learner/v2/learning-plan';
  }
...
function actionsPost(req, res) {
  ...
  /*if (action === 'addedToLearningPlan') {
        ...
        redirectPath = '/prototypes/learner/v2/suggested-learning';
    }*/
...
function feedbackGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/feedback/index', viewData);
}