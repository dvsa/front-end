...
function registerEmailGet(req, res) {
  ...
  if (clearSession === 'true') {
    return res.redirect('/prototypes/learner/v2');
  }
...
function registerEmailPost(req, res) {
  ...
  if (registrationEmailError === true) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v2/registration/review');
    } else {
      return res.redirect('/prototypes/learner/v2/registration/personal-details');
    }
  }
}
// **************************************************************************************
...
function registerPersonalGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/registration/personal-details/index', viewData);
}
...
function registerPersonalPost(req, res) {
  ...
  if (registrationPersonalError === true) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v2/registration/department');
    }
  }
}
// **************************************************************************************
...
function registerDepartmentGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/registration/department/index', viewData);
}
...
function registerDepartmentPost(req, res) {
  ...
  if (parseInt(department) < 1) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v2/registration/area-of-work');
    }
  }
}
// **************************************************************************************
...
function registerAreaGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/registration/area-of-work/index', viewData);
}
...
function registerAreaPost(req, res) {
  ...
  if (registrationJob2Error === true) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v2/registration/grade');
    }
  }
}
// **************************************************************************************
...
function registerGradeGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/registration/grade/index', viewData);
}
...
function registerGradePost(req, res) {
  ...
  if (registrationJob2Error === true) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v2/registration/password');
    }
  }
}
// **************************************************************************************
...
function registerPasswordGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/registration/password/index', viewData);
}
...
function registerReviewGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/registration/review/index', viewData);
}
...
function registerReviewPost(req, res) {
  ...
  return res.redirect('/prototypes/learner/v2/registration/complete');
}
// **************************************************************************************
// Complete GET
// **************************************************************************************
function registerCompleteGet(req, res) {
  ...
  return res.render('prototypes/learner/v2/registration/complete/index', viewData);
}