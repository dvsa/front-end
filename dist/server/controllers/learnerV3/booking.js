...
function bookingDateGet(req, res) {
  ...
  return res.render('prototypes/learner/v3/booking/index', viewData);
}
...
function bookingDatePost(req, res) {
  ...
  return res.redirect('/prototypes/learner/v3/booking/payment');
}
...
function bookingPaymentGet(req, res) {
  ...
  return res.render('prototypes/learner/v3/booking/payment', viewData);
}

function bookingPaymentPost(req, res) {
  return res.redirect('/prototypes/learner/v3/booking/confirm');
}
...
function bookingConfirmGet(req, res) {
  ...
  return res.render('prototypes/learner/v3/booking/confirm', viewData);
}
...
function bookingCompleteGet(req, res) {
  ...
  return res.render('prototypes/learner/v3/booking/complete', viewData);
}