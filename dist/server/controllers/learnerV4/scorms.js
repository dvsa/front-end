...
function basicFireSafetyGet(req, res) {
  ...
  return res.render('prototypes/learner/v4/scorms/basic-fire-safety/index', viewData);
}
...
function scormCompleteGet(req, res) {
  ...
  return res.render('prototypes/learner/v4/scorms/basic-fire-safety/complete', viewData);
}