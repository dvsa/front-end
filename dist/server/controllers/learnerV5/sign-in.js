...
function indexGet(req, res) {
  ...
  // return res.render('prototypes/learner/v5/index', { loggedOut: false });
  ...
  return res.render('prototypes/learner/v5/index', viewData);
}
...
function indexPost(req, res) {
  ...
  if ((0, _validationFunctions.validateEmail)(email) && password.length >= 2) {
    return res.redirect('/prototypes/learner/v5/home');
  } else {
    signinError = true;
