...
function basicFireSafetyGet(req, res) {
  ...
  return res.render('prototypes/learner/v6/scorms/basic-fire-safety/index', viewData);
}
...
function scormCompleteGet(req, res) {
  ...
  return res.render('prototypes/learner/v6/scorms/basic-fire-safety/complete', viewData);
}