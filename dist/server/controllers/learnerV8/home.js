...
function plannedGet(req, res) {
  ...
  return res.render('prototypes/learner/v8/learning-plan/index', viewData);
}
...
function profileGet(req, res) {
  ...
  return res.render('prototypes/learner/v8/profile/index', viewData);
}
...
function recordGet(req, res) {
  ...
  return res.render('prototypes/learner/v8/learning-record/index', viewData);
}
...
function suggestedGet(req, res) {
  ...
  return res.render('prototypes/learner/v8/suggested-learning/index', viewData);
}
...
function suggestedFullGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v8/suggested-learning/full', viewData);
}
...
function suggestedAllGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v8/suggested-learning/all', viewData);
}
...
function suggestedAllHMRCGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v8/suggested-learning/hmrc', viewData);
}
...
function suggestedAllHMRCColsGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v8/suggested-learning/hmrc-cols', viewData);
}
...
function searchPost(req, res) {
  ...
  return res.redirect('/prototypes/learner/v8/search');
}
...
function feedbackGet(req, res) {
  ...
  return res.render('prototypes/learner/v8/feedback/index', viewData);
}
...
function privacyGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v8/privacy/index', viewData);
}