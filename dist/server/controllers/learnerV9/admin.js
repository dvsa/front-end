...
function adminGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/admin/index', viewData);
}
function adminPost(req, res) {
  ...
  if (eventsSubmit == 'events') {
    redirectPath = '/prototypes/learner/v9/admin/events-list';
  } else if (courseSubmit == 'courses') {
    redirectPath = '/prototypes/learner/v9/admin/course-list';
  } else {
    redirectPath = '/prototypes/learner/v9/admin';
  }
...
function adminCourseListGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/admin/course-list', viewData);
}
function adminCourseListPost(req, res) {
  const {} = req.body;

  return res.redirect('/prototypes/learner/v9/admin');
}
...
function adminEventsListGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/admin/events-list', viewData);
}
...
function adminEditGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/admin/edit', viewData);
}
...
function adminAddGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/admin/add', viewData);
}
function adminAddPost(req, res) {
  const {} = req.body;

  return res.redirect('/prototypes/learner/v9/admin/add-details');
}
...
function adminAddDetailsGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/admin/add-details', viewData);
}
function adminAddDetailsPost(req, res) {
  ...
  if (addRowEvent == 'addRow') {
    ...
    return res.redirect('/prototypes/learner/v9/admin/add-assets');
  }
}
...
function adminAddAssetsGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/admin/add-assets', viewData);
}
function adminAddAssetsPost(req, res) {
  const {} = req.body;

  return res.redirect('/prototypes/learner/v9/admin/add-review');
}
...
function adminAddReviewGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/admin/add-review', viewData);
}
function adminAddReviewPost(req, res) {
  const {} = req.body;

  return res.redirect('/prototypes/learner/v9/add-complete');
}
