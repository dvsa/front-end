...
function bookingDateGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/booking/index', viewData);
}
...
function bookingDatePost(req, res) {
  ...
  return res.redirect('/prototypes/learner/v9/booking/payment');
}
...
function bookingPaymentGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/booking/payment', viewData);
}

function bookingPaymentPost(req, res) {
  return res.redirect('/prototypes/learner/v9/booking/confirm');
}
...
function bookingConfirmGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/booking/confirm', viewData);
}
...
function bookingCompleteGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/booking/complete', viewData);
}
