...
function registerEmailGet(req, res) {
  ...
  if (clearSession === 'true') {
    return res.redirect('/prototypes/learner/v9');
  }
  ...
  return res.render('prototypes/learner/v9/registration/index', viewData);
}
...
function registerEmailPost(req, res) {
  ...
  if (registrationEmailError === true) {
    ...
    return res.redirect('/prototypes/learner/v9/registration');
  } else {
    req.session.registrationEmailError = req.session.registrationEmailErrorMessage = null;
    if (editMode === true) {
      req.session.editMode = null;
      return res.redirect('/prototypes/learner/v9/registration/review');
    } else {
      return res.redirect('/prototypes/learner/v9/registration/personal-details');
    }
  }
}
// **************************************************************************************
...
function registerPersonalGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/registration/personal-details/index', viewData);
}
...
function registerPersonalPost(req, res) {
  ...
  if (registrationPersonalError === true) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v9/registration/department');
    }
  }
}
// **************************************************************************************
...
function registerDepartmentGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/registration/department/index', viewData);
}
...
function registerDepartmentPost(req, res) {
  ...
  if (parseInt(department) < 1) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v9/registration/area-of-work');
    }
  }
}
// **************************************************************************************
...
function registerAreaGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/registration/area-of-work/index', viewData);
}
...
function registerAreaPost(req, res) {
  ...
  if (registrationJob2Error === true) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v9/registration/grade');
    }
  }
}
// **************************************************************************************
...
function registerGradeGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/registration/grade/index', viewData);
}
...
function registerGradePost(req, res) {
  ...
  if (registrationJob2Error === true) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v9/registration/password');
    }
  }
}
// **************************************************************************************
...
function registerPasswordGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/registration/password/index', viewData);
}
...
function registerReviewGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/registration/review/index', viewData);
}
...
function registerReviewPost(req, res) {
  ...
  return res.redirect('/prototypes/learner/v9/registration/complete');
}
// **************************************************************************************
// Complete GET
// **************************************************************************************
function registerCompleteGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/registration/complete/index', viewData);
}