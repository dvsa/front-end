...
function basicFireSafetyGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/scorms/basic-fire-safety/index', viewData);
}
...
function scormCompleteGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/scorms/basic-fire-safety/complete', viewData);
}