...
*/
var addToSession = exports.addToSession = function addToSession(req, sessionName) {
  ...
  return function (appendedObject) {
    ...
    Object.entries(appendedObject).forEach(function (_ref) {
