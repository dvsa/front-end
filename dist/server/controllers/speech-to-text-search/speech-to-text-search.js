...
exports.removeDefect = exports.postSearchQuery = exports.getSearchQuery = exports.captureFormValues = void 0;
var _addToSession = require("./helpers/add-to-session");
// Helper function to render view with view data
var renderview = function renderview(req, res, url) {
  res.render(url, {
    viewData: req.session.viewData || {}
  });
};
var getSearchQuery = exports.getSearchQuery = function getSearchQuery(req, res) {
  return renderview(req, res, 'prototypes/speech-to-text/index');
};
var postSearchQuery = exports.postSearchQuery = function postSearchQuery(req, res) {
  ...
  (0, _addToSession.addToSession)(req, 'viewData')({
    search: req.body.q
  });
...
var captureFormValues = exports.captureFormValues = function captureFormValues(req, res) {
  // Gets a refer to req.session.viewData
  var addToViewDataSession = (0, _addToSession.addToSession)(req, 'viewData');
...
var removeDefect = exports.removeDefect = function removeDefect(req, res) {
