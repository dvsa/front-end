...
export class StickySidebar {
  ...
  calcDimensions() {
    ...
    dims.containerTop = this.offsetRelative(this.container).top;
  ...
  _calcDimensionsWithScroll() {
    ...
    dims.sidebarLeft = this.offsetRelative(this.sidebar).left;
  ...
  _getStyle(affixType) {
    ...
    style.outer = this.extend({ height: '', position: '' }, style.outer);
    style.inner = this.extend(
      {
        position: 'relative',
        top: '',
        left: '',
  ...
  stickyPosition(force) {
    ...
    if ((this.affixedType != affixType || force) && affixType) {
      ...
      this.eventTrigger(this.sidebar, affixEvent);

      if ('STATIC' === affixType) this.removeClass(this.sidebar, this.options.stickyClass);
      else this.addClass(this.sidebar, this.options.stickyClass);
      ...
      this.eventTrigger(this.sidebar, affixedEvent);
    } else {
  ...
  _widthBreakpoint() {
    if (window.innerWidth <= this.options.minWidth) {
      ...
      this.removeClass(this.sidebar, this.options.stickyClass);
