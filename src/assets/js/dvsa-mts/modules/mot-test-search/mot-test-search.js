...
export class MOTTestSearch {
  constructor() {
    this.elements = {
      ...
      searchValueLabelText: document.querySelector('#search-value-label-text'),
  ...
  updateFormBasedOnTypeValue = () => {
    ...
    this.elements.searchValueLabelText.innerText = this.messages.inputLabels[this.elements.type.value];
    ...
    const dateFieldTypes = [this.state.typeOptions.vtsDate, this.state.typeOptions.tester];
