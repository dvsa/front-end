...
export function areasPost(req, res) {
  ...
  // return res.redirect('/prototypes/learner/v10/your-profile/area-of-work/levels?level1=true');

  return res.redirect('/prototypes/learner/v10/your-profile');
}
...
export function areasLevelsPost(req, res) {
  ...
  return res.redirect('prototypes/learner/v10/area-of-work/levels');
}
...
export function areasJoinedLevelsPMPost(req, res) {
  ...
  return res.redirect('prototypes/learner/v10/area-of-work/joined-levels-pm');
}
