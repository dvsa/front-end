...
export function basicFireSafetyGet(req, res) {
  ...
  return res.render('prototypes/learner/v10/scorms/basic-fire-safety/index', viewData);
}
...
export function scormCompleteGet(req, res) {
  ...
  return res.render('prototypes/learner/v10/scorms/basic-fire-safety/complete', viewData);
}
