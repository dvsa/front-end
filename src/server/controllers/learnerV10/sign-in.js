...
export function indexGet(req, res) {
  ...
  // return res.render('prototypes/learner/v10/index', { loggedOut: false });
  ...
  return res.render('prototypes/learner/v10/index', viewData);
}
...
export function indexPost(req, res) {
  ...
  if (validateEmail(email) && password.length >= 2) {
    return res.redirect('/prototypes/learner/v10/home');
  } else if (email == 'admin') {
