...
export function resourceGet(req, res) {
  ...
  if (isNumeric(parseInt(resourceID)) && parseInt(resourceID) >= 1) {
    returnPath = 'prototypes/learner/v2/resource/' + resourceID;
  } else if (availableTypes.includes(resourceType)) {
    returnPath = 'prototypes/learner/v2/resource/' + resourceType;
  } else {
    returnPath = 'prototypes/learner/v2/resource/index';
  }
