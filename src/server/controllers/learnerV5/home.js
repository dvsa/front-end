...
export function homeGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/home/index', viewData);
}
...
export function plannedGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/learning-plan/index', viewData);
}
...
export function recordGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/learning-record/index', viewData);
}
...
export function suggestedGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/suggested-learning/index', viewData);
}
...
export function searchGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/search/index', viewData);
}
...
export function searchPost(req, res) {
  ...
  return res.redirect('/prototypes/learner/v5/search');
}
...
export function feedbackGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/feedback/index', viewData);
}
