...
export function registerEmailGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/registration/index', viewData);
}
...
export function registerEmailPost(req, res) {
  ...
  if (registrationEmailError === true) {
    ...
    return res.redirect('/prototypes/learner/v5/registration');
  } else {
    req.session.registrationEmailError = req.session.registrationEmailErrorMessage = null;
    if (editMode === true) {
      req.session.editMode = null;
      return res.redirect('/prototypes/learner/v5/registration/review');
    } else {
      return res.redirect('/prototypes/learner/v5/registration/personal-details');
    }
  }
}
// **************************************************************************************
...
export function registerPersonalGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/registration/personal-details/index', viewData);
}
...
export function registerPersonalPost(req, res) {
  ...
  if (registrationPersonalError === true) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v5/registration/department');
    }
  }
}
// **************************************************************************************
...
export function registerDepartmentGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/registration/department/index', viewData);
}
...
export function registerDepartmentPost(req, res) {
  ...
  if (parseInt(department) < 1) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v5/registration/area-of-work');
    }
  }
}
// **************************************************************************************
...
export function registerAreaGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/registration/area-of-work/index', viewData);
}
...
export function registerAreaPost(req, res) {
  ...
  if (registrationJob2Error === true) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v5/registration/grade');
    }
  }
}
// **************************************************************************************
...
export function registerGradeGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/registration/grade/index', viewData);
}
...
export function registerGradePost(req, res) {
  ...
  if (registrationJob2Error === true) {
    ...
    if (editMode === true) {
      ...
      return res.redirect('/prototypes/learner/v5/registration/password');
    }
  }
}
// **************************************************************************************
...
export function registerPasswordGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/registration/password/index', viewData);
}
...
export function registerReviewGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/registration/review/index', viewData);
}
...
export function registerReviewPost(req, res) {
  ...
  return res.redirect('/prototypes/learner/v5/registration/complete');
}
// **************************************************************************************
// Complete GET
// **************************************************************************************
export function registerCompleteGet(req, res) {
  ...
  return res.render('prototypes/learner/v5/registration/complete/index', viewData);
}
