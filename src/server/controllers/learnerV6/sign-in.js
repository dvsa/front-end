...
export function indexGet(req, res) {
  ...
  // return res.render('prototypes/learner/v6/index', { loggedOut: false });
  ...
  return res.render('prototypes/learner/v6/index', viewData);
}
...
export function indexPost(req, res) {
  ...
  if (validateEmail(email) && password.length >= 2) {
    return res.redirect('/prototypes/learner/v6/home');
  } else {
    signinError = true;
