...
export function homeGet(req, res) {
  ...
  return res.render('prototypes/learner/v7/home/index', viewData);
}
...
export function plannedGet(req, res) {
  ...
  return res.render('prototypes/learner/v7/learning-plan/index', viewData);
}
...
export function profileGet(req, res) {
  ...
  return res.render('prototypes/learner/v7/profile/index', viewData);
}
...
export function recordGet(req, res) {
  ...
  return res.render('prototypes/learner/v7/learning-record/index', viewData);
}
...
export function suggestedGet(req, res) {
  ...
  return res.render('prototypes/learner/v7/suggested-learning/index', viewData);
}
...
export function searchGet(req, res) {
  ...
  return res.render('prototypes/learner/v7/search/index', viewData);
}
...
export function searchPost(req, res) {
  ...
  return res.redirect('/prototypes/learner/v7/search');
}
...
export function feedbackGet(req, res) {
  ...
  return res.render('prototypes/learner/v7/feedback/index', viewData);
}
...
export function privacyGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v7/privacy/index', viewData);
}
