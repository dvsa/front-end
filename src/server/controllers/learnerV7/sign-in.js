...
export function indexGet(req, res) {
  ...
  // return res.render('prototypes/learner/v7/index', { loggedOut: false });
  ...
  return res.render('prototypes/learner/v7/index', viewData);
}
...
export function indexPost(req, res) {
  ...
  if (validateEmail(email) && password.length >= 2) {
    return res.redirect('/prototypes/learner/v7/home');
  } else {
    signinError = true;
