...
export function adminEventsListGet(req, res) {
  ...
  return res.render('prototypes/learner/v8/admin/events-list', viewData);
}
...
export function adminAddPost(req, res) {
  ...
  return res.redirect('/prototypes/learner/v8/admin/add-details');
}
...
export function adminAddDetailsPost(req, res) {
  ...
  if (addRowEvent == 'addRow') {
    ...
    return res.redirect('/prototypes/learner/v8/admin/add-assets');
  }
}
...
export function adminAddAssetsGet(req, res) {
  ...
  return res.render('prototypes/learner/v8/admin/add-assets', viewData);
}
...
export function adminAddReviewGet(req, res) {
  ...
  return res.render('prototypes/learner/v8/admin/add-review', viewData);
}
export function adminAddReviewPost(req, res) {
  const {} = req.body;

  return res.redirect('/prototypes/learner/v8/add-complete');
}
