...
export function resetPasswordGet(req, res) {
  ...
  return res.render('prototypes/learner/v8/authentication/reset-password', viewData);
}
...
export function resetPasswordPost(req, res) {
  ...
  if (validateEmail(email)) {
    redirectPath = '/prototypes/learner/v8/email-sent';
  } else {
    req.session.emailError = true;
    redirectPath = '/prototypes/learner/v8/reset-password';
  }
...
export function emailSentGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v8/authentication/email-sent', viewData);
}
...
export function enterNewPasswordGet(req, res) {
  ...
  return res.render('prototypes/learner/v8/authentication/enter-new-password', viewData);
}
...
export function enterNewPasswordPost(req, res) {
  ...
  if (passwordError === true) {
    ...
    redirectPath = '/prototypes/learner/v8/enter-new-password';
  } else {
    // all good!
    redirectPath = '/prototypes/learner/v8/reset-success';
  }
...
export function resetSuccessGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v8/authentication/reset-success', viewData);
}
...
export function createNewPasswordGet(req, res) {
  ...
  return res.render('prototypes/learner/v8/authentication/create-new-password', viewData);
}
...
export function createNewPasswordPost(req, res) {
  ...
  if (passwordError === true) {
    ...
    req.session.passwordErrorInputMessageOne = passwordErrorInputMessageOne;
    req.session.passwordErrorInputMessageTwo = passwordErrorInputMessageTwo;
    redirectPath = '/prototypes/learner/v8/create-new-password';
  } else {
    // all good!
    redirectPath = '/prototypes/learner/v8/create-success';
  }
...
export function createSuccessGet(req, res) {
  let viewData;
  viewData = {};
  return res.render('prototypes/learner/v8/authentication/create-success', viewData);
}
