...
export function actionsGet(req, res) {
  ...
  if (action === 'addedToLearningPlan') {
    ...
    redirectPath = '/prototypes/learner/v9/home';
  }
  ...
  if (action === 'completeFireTraining' && id === '15') {
    ...
    redirectPath = '/prototypes/learner/v9/scorms/basic-fire-safety/complete';
  }
  ...
  if (action == 'workAreaHasBeenUpdated') {
    ...
    redirectPath = '/prototypes/learner/v9/your-profile';
  }
  ...
  if (action == 'showPreFilteredResults') {
    ...
    redirectPath = '/prototypes/learner/v9/search';
  }
...
export function actionsPost(req, res) {
  ...
  /*if (action === 'addedToLearningPlan') {
          ...
          redirectPath = '/prototypes/learner/v9/suggested-learning';
      }*/
