...
export function areasGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/area-of-work/index', viewData);
}
...
export function areasPost(req, res) {
  ...
  // return res.redirect('/prototypes/learner/v9/your-profile/area-of-work/levels?level1=true');

  return res.redirect('/prototypes/learner/v9/your-profile');
}
...
export function areasLevelsGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/area-of-work/levels', viewData);
}
...
export function areasLevelsPost(req, res) {
  ...
  return res.redirect('prototypes/learner/v9/area-of-work/levels');
}
...
export function areasJoinedLevelsGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/area-of-work/joined-levels', viewData);
}
...
export function areasJoinedLevelsPMGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/area-of-work/joined-levels-pm', viewData);
}
export function areasJoinedLevelsPMPost(req, res) {
  ...
  return res.redirect('prototypes/learner/v9/area-of-work/joined-levels-pm');
}
...
export function otherAreasGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/area-of-work/others', viewData);
}
...
export function interestsGet(req, res) {
  ...
  return res.render('prototypes/learner/v9/area-of-work/interests', viewData);
}
